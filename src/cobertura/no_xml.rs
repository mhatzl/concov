...
impl From<super::schema::Coverage> for Coverage {
    fn from(value: super::schema::Coverage) -> Self {
        Self {
...
impl From<super::schema::Sources> for Sources {
    fn from(value: super::schema::Sources) -> Self {
        Self {
            source: value.source,
        }
    }
...
impl From<super::schema::Packages> for Packages {
    fn from(value: super::schema::Packages) -> Self {
        Self {
...
impl From<super::schema::Package> for Package {
    fn from(value: super::schema::Package) -> Self {
        Self {
            name: value.name,
            line_rate: value.line_rate,
            branch_rate: value.branch_rate,
...
impl From<super::schema::Classes> for Classes {
    fn from(value: super::schema::Classes) -> Self {
        Self {
...
impl From<super::schema::Class> for Class {
    fn from(value: super::schema::Class) -> Self {
        Self {
            name: value.name,
...
impl From<super::schema::Methods> for Methods {
    fn from(value: super::schema::Methods) -> Self {
        Self {
...
impl From<super::schema::Method> for Method {
    fn from(value: super::schema::Method) -> Self {
        Self {
            name: value.name,
...
impl From<super::schema::Lines> for Lines {
    fn from(value: super::schema::Lines) -> Self {
        Self {
...
impl From<super::schema::Line> for Line {
    fn from(value: super::schema::Line) -> Self {
        Self {
            number: value.number,
            hits: value.hits,
            branch: value.branch,
...
impl From<super::schema::Conditions> for Conditions {
    fn from(value: super::schema::Conditions) -> Self {
        Self {
...
impl From<super::schema::Condition> for Condition {
    fn from(value: super::schema::Condition) -> Self {
        Self {
            number: value.number,
